...
```js
/(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/ // 身份证正则

/^([\u4e00-\u9fa5\·]{2,10})$/ // 中文姓名

/^((https?|ftp|file):\/\/)?([\da-z.-]+)\.([a-z.]{2,6})(\/\w\.-]*)*\/?$/ // URL链接
...
/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/ // ipv4地址正则

/^[1-9][0-9]{4,10}$/ // 检验qq号格式是否正确
